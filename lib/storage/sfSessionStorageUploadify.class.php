...
class sfSessionStorageUploadify extends sfSessionStorage
{
  ...
  {
    $for = sfConfig::get("app_plUploadify_enabled_routes");
    if(!is_array($for) || !$for)
    {
      return false;
    }
